...
<header class="banner" id="section-start">
  <div class="container-fluid">
    <div class="row">
      <img id="landing-img" src="<?= get_template_directory_uri(); ?>/dist/images/frontpic.jpg">
      <nav id="navbar" class="nav-down">
          <ul class="topnav" id="Topnav">
            ...
            <li class="social-icon">
              <a href="<?php echo get_theme_mod('facebook_address'); ?>" target="_blank"><i class="fa fa-2x fa-facebook"></i></a>
              <a href="<?php echo get_theme_mod('twitter_address'); ?>" target="_blank"><i class="fa fa-2x fa-twitter"></i></a>
            </li>
